...
while red_health > 0 and blue_health > 0:
	...
	damage_taken_blue = 2 * damage_taken(strong_attack_damage(level, strength), defense) + damage_taken(normal_attack_damage(level,strength), defense)
	...
	damage_taken_red = 3 * damage_taken(normal_attack_damage(level, strength), defense) + damage_taken(throw_attack_damage(level,strength), defense)
